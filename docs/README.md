...
| [`ADOPTION_PLAYBOOK.md`](ADOPTION_PLAYBOOK.md) | Legion-decided per-app adoption strategy — role names, claims augmentation, phased adoption order (Prose → Ideas → Tutor), per-app wiring details. |
